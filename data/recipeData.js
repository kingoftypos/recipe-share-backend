[
  {
    ...
    coverImg:
      "https://www.vegrecipesofindia.com/wp-content/uploads/2010/08/karela-sabji-recipe.jpg",
    isVeg: true,
    cuisine: "Indian",
    course: "Side Dish",
    mainIngredients: [
    ...
    steps: [
      ...
      "Heat oil in a heavy bottomed pan or a kadhai. Add cumin seeds(Jeera) and let it sizzle.Once the cumin seeds have sizzled, add onions and saute them till it turns golden brown in color.",
      ".Add the karela, red chilli powder, amchur powder, coriander powder and besan. Stir to combine the masalas into the karela.Drizzle a little extra oil on the top and mix again",
      "Cover the pan and simmer Masala Karela stirring occasionally until everything comes together well. Turn off the heat.Transfer Masala Karela into a serving bowl and serve.",
      " Serve Masala Karela along with Panchmel Dal and Phulka for a weekday meal with your family",
    ],
    mainRegion: ["uttar pradesh"],
    createdBy: "Admin",
  ...
  {
    title: "Cauliflower Leaves Chutney (Recipe in Hindi)",
